// Binary JS - with our own stuff at the bottom...
...
function Transport(id, client){
  ...
  client.on('stream', function(stream, meta){
    ...
    stream.on('end', function(){
      ...
      a.download = meta.name || 'untitiled file';
  ...
  this.send = function(file, to, name){
    client.send(file, {target:to, name: name});
  }
